...
# from models.cross_attention import CrossAttentionWithGating
from models.DualPathFusion import DualPathFusion
from models.DirectAttention import DirectAttentionFusion
__all__ = [
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.fusion_attention = DirectAttentionFusion(in_channels=512)
        # 这个是分割头的反卷积代码
    ...
    def forward(self, x1, x2):
        ...
        x2 = self.forward_first(x2)
        # print(f'x1-shape:{x1.shape}')
        x = self.fusion_attention(x1, x2)
