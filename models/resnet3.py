...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv3d(
            2,  # 这里是输入图像特征的channel，如果是DWI和FLAIR叠到一起，这里就是2
            64,
            kernel_size=7,
            stride=(2, 2, 2),
            padding=(3, 3, 3),
        ...
        self.cls_head = nn.Sequential(nn.AdaptiveAvgPool3d((1, 1, 1)), nn.Flatten(),
                                       nn.Linear(in_features=512, out_features=num_seg_classes, bias=True))
