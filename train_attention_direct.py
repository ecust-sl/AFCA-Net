...
def train(data_loader, test_loader, val_loader, model, optimizer, scheduler, total_epochs, save_interval, save_folder, sets,
    ...
    wandb.init(
        project="Med3D-KF-5",
        name=f"0505_fold_{num_KF}_2_3_loss_direct_attention",
        config={
    ...
    for epoch in range(total_epochs):
        ...
        for batch_id, batch_data in enumerate(data_loader):
            ...
            volumes, flair, label_masks, tss_label, tss_label_3 = batch_data
            ...
            # fused_feat = volumes
            logits_2, logits_3 = model(volumes, flair)
        ...
        with torch.no_grad():
            for batch_id, batch_data in enumerate(test_loader):
                # getting data batch
                # batch_id_sp = epoch * batches_per_epoch
                val_volumes, val_flair, val_label_masks, val_tss_label, val_tss_label_3 = batch_data
                ...
                logits_2, logits_3 = model(val_volumes, val_flair)
            ...
            if val_metrics['val/auc'] + val_metrics['val/auc_3'] > best_metrics['val_auc'] + best_metrics['val_auc_3']:
                ...
                # wandb.save(f"{save_folder}/fold_{num_KF}_best.pth")
            ...
            with torch.no_grad():
                for batch_id, batch_data in enumerate(val_loader):
                    # getting data batch
                    # batch_id_sp = epoch * batches_per_epoch
                    out_val_volumes, out_val_flair, out_val_label_masks, out_val_tss_label, out_val_tss_label_3 = batch_data
                    ...
                    if not sets.no_cuda:
                        ...
                        # Forward pass
                    # val_fused_feat = torch.cat([val_volumes, val_flair], dim=1)
                    logits_2, logits_3 = model(out_val_volumes, out_val_flair)
                ...
                wandb.log({**train_metrics, **val_metrics, **val_out_metrics})
...
if __name__ == '__main__':
    ...
    for i in range(3, 6):
        ...
        if sets.ci_test:
            ...
            sets.input_H = 224
            sets.input_W = 224
        KF_root = '/home/shilei/project/MedicalNet/KFData/kfold_data_all_final'
        ...
        sets.model = 'resnet_direct_attention'
